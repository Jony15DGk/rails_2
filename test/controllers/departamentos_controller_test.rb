...
class DepartamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departamento" do
    assert_difference("Departamento.count") do
      post departamentos_url, params: { departamento: { clave: @departamento.clave, nivel: @departamento.nivel, nombre: @departamento.nombre } }
    end
  ...
  test "should update departamento" do
    patch departamento_url(@departamento), params: { departamento: { clave: @departamento.clave, nivel: @departamento.nivel, nombre: @departamento.nombre } }
